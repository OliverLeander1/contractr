  ...
  return (
    <div className="relative w-24 h-24 flex items-center justify-center">
      ...
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
        {/* Background circle */}
        <circle cx="48" cy="48" r="44" fill="#f0f7f3"/>

        {/* Cloud shape */}
        <g className="cloud-pulse" style={{ transformOrigin: "48px 30px" }}>
          <path d="M28 38 Q28 28 38 28 Q40 20 50 20 Q62 20 64 30 Q72 30 72 38 Q72 46 64 46 H32 Q28 46 28 38Z" fill="#1a5c38" opacity="0.12"/>
          <path d="M30 38 Q30 29 40 29 Q42 21 51 21 Q63 21 65 31 Q73 31 73 39 Q73 46 65 46 H33 Q29 46 29 39Z" fill="none" stroke="#1a5c38" strokeWidth="2" strokeLinejoin="round"/>
        </g>

        {/* Document */}
        <g className="doc-float" style={{ transformOrigin: "48px 62px" }}>
          <rect x="35" y="50" width="26" height="32" rx="3" fill="white" stroke="#1a5c38" strokeWidth="1.8"/>
          <line x1="40" y1="57" x2="56" y2="57" stroke="#1a5c38" strokeWidth="1.5" strokeLinecap="round" className="line1"/>
          <line x1="40" y1="63" x2="52" y2="63" stroke="#a7c9b7" strokeWidth="1.5" strokeLinecap="round" className="line2"/>
          <line x1="40" y1="69" x2="54" y2="69" stroke="#a7c9b7" strokeWidth="1.5" strokeLinecap="round" className="line2"/>
        </g>

        {/* Upload arrow */}
        <g className="arrow-bounce" style={{ transformOrigin: "48px 46px" }}>
          <line x1="48" y1="52" x2="48" y2="42" stroke="#1a5c38" strokeWidth="2.5" strokeLinecap="round"/>
          <polyline points="43,47 48,42 53,47" stroke="#1a5c38" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative w-24 h-24 flex items-center justify-center">
      ...
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
        ...
        {/* Status dots */}
        <circle cx="31" cy="31" r="3" fill="#1a5c38" className="check-pop"/>
        <circle cx="31" cy="43" r="3" fill="#f59e0b" className="amber-blink"/>

        {/* Magnifier */}
        <g className="scan-move" style={{ transformOrigin: "56px 52px" }}>
          <circle cx="56" cy="52" r="14" fill="white" fillOpacity="0.9" stroke="#1a5c38" strokeWidth="2.2"/>
          <circle cx="56" cy="52" r="9" fill="none" stroke="#1a5c38" strokeWidth="1.5" strokeOpacity="0.3"/>
          <line x1="66" y1="62" x2="74" y2="70" stroke="#1a5c38" strokeWidth="2.8" strokeLinecap="round"/>
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative w-24 h-24 flex items-center justify-center">
      ...
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
        ...
        <g className="person-bob" style={{ transformOrigin: "48px 55px" }}>
          {/* Body */}
          <rect x="34" y="55" width="28" height="22" rx="8" fill="#1a5c38" opacity="0.85"/>
          {/* Head */}
          <circle cx="48" cy="42" r="11" fill="#1a5c38" opacity="0.85"/>
          {/* Face highlight */}
    ...
    <div className="relative w-24 h-24 flex items-center justify-center">
      ...
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
        ...
        <g className="board-slide" style={{ transformOrigin: "48px 52px" }}>
          {/* Clip top */}
          <rect x="38" y="18" width="20" height="8" rx="2" fill="#1a5c38"/>
          {/* Board */}
          <rect x="24" y="22" width="48" height="56" rx="5" fill="white" stroke="#1a5c38" strokeWidth="1.8"/>

          {/* Header stripe */}
          <rect x="24" y="22" width="48" height="14" rx="5" fill="#1a5c38" opacity="0.08"/>
          <text x="35" y="32" fontSize="7" fill="#1a5c38" fontWeight="600" fontFamily="system-ui">PROJEKT</text>

          {/* Row 1 */}
          <rect x="32" y="40" width="32" height="8" rx="2" fill="#f3f4f6"/>
          <g className="item-check-1">
            <circle cx="42" cy="44" r="4" fill="#1a5c38"/>
          ...
          <g className="item-check-2">
            <circle cx="42" cy="56" r="4" fill="#1a5c38"/>
