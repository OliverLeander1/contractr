...
export default function KontraktSide({ params }: { params: Promise<{ id: string }> }) {
  ...
  const betalingsplan = [
    ...
    { milepæl: "Næsten færdig", andel: "30%", beløb: fmtKr(total * 0.30), status: "kommende" },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-accent border border-primary/20 rounded-2xl p-4 mb-6 flex items-center gap-3">
          ...
          <p className="text-sm text-primary leading-relaxed">Denne kontrakt er baseret på AB-Forbruger standardbetingelserne, som giver dig som forbruger den bedste beskyttelse ved private byggesager over 3.000 kr.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-6">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-left border-b border-gray-100">
                    <th className="pb-2 font-semibold text-gray-500">Milepæl</th>
                    <th className="pb-2 font-semibold text-gray-500">Andel</th>
                    <th className="pb-2 font-semibold text-gray-500">Beløb</th>
                  </tr>
                </thead>
            ...
            <div className="border-t border-gray-100 pt-6">
              ...
              <p>Arbejdet afleveres ved skriftlig meddelelse til forbrugeren jf. AB-Forbruger § 37. Forbrugeren har 5 års reklamationsret på mangler fra afleveringsdatoen. Forbrugeren kan tilbageholde betaling svarende til manglernes udbedring ved dokumenterede mangler jf. § 25, stk. 3.</p>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="border border-gray-100 rounded-xl p-4">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-2">Entreprenør</p>
              <p className="text-xs text-gray-400 mt-2">Håndværkeren skal bekræfte aftalen skriftligt</p>
              <div className="flex items-center gap-2 mt-3">
                <div className="w-3 h-3 rounded-full bg-amber-400" />
                <p className="text-xs text-amber-600 font-medium">Afventer bekræftelse</p>
              </div>
            </div>
          </div>
        </div>
