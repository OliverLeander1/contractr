        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex-1 flex justify-center">
            <div className="inline-flex items-center bg-gray-100 rounded-xl p-1 gap-1">
              ...
              <Link href="/haandvaerker/sager" className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-[#1e3a2a] text-white text-sm font-semibold shadow-sm transition-all">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <Link href="/haandvaerker/nyt-tilbud" className="hidden sm:flex items-center gap-2 text-sm font-semibold bg-[#1e3a2a] text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
              Nyt tilbud
            </Link>
            <div className="w-8 h-8 rounded-full bg-[#1e3a2a]/10 flex items-center justify-center text-[#1e3a2a] font-semibold text-sm">{initials}</div>
          </div>
        </div>
      </header>
