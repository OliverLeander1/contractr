  ...
  return (
    <FlowLayout aktivTrin={3}>
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-gray-50 border border-gray-100 mb-8">
        ...
        <p className="text-xs text-gray-500 leading-relaxed">Dit dokument sendes til vores AI til analyse og vises kun til dig. Vi gemmer ikke filer på vores servere — din rapport og dine projektdata opbevares kun i din browser.</p>
      </div>
